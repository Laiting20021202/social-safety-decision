...
def generate_launch_description() -> LaunchDescription:
    ...
    allow_hsv = LaunchConfiguration("allow_hsv_placeholder")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("allow_hsv_placeholder", default_value="false"),
            DeclareLaunchArgument("use_rviz", default_value="true"),
            DeclareLaunchArgument("auto_start", default_value="true"),
            DeclareLaunchArgument("output_root", default_value="results"),
            _include(
                "simulation.launch.py",
                {"mode": "perception", "scenario": scenario, "headless": headless},
            ),
                ...
                parameters=[
                    {
                        ...
                        "allow_hsv_placeholder": allow_hsv,
                        "use_sim_time": True,
                    }
                ],
                output="screen",
            ...
            Node(
                ...
                parameters=[{"mode": "perception", "use_sim_time": True}],
                output="screen",
            ),
            Node(
